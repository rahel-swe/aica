      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
          ...
          <div className="flex-1 max-w-[480px]">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-5 leading-16">
              {m.landing_roadmap_heading_line1()}
              <br />
              {m.landing_roadmap_heading_line2()}
            </h2>

            <p className="text-lg text-muted-foreground leading-relaxed mb-6 lt:font-heading">
            ...
            <Button asChild className="px-8 py-6.5 gap-2">
  ...
  return (
    <section className="py-20 md:py-28 bg-foreground relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-5 sm:px-8 text-center">
        <h2 className="text-5xl md:text-6xl lg:text-[4rem] font-bold tracking-tight leading-[1.1] mb-5 text-background">
          {m.cta_title_line1()}
          <br />
          {m.cta_title_line2()}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Button className="px-8 py-6.5 gap-2 bg-background text-foreground hover:bg-background/90">
